...
try:
    joblib.dump(history.history, os.path.join(BASE_DIR, 'models', 'color_history.pkl'))
    print('Saved training history to models/color_history.pkl')
except Exception:
    print('Warning: failed to save training history.')
...
plots.plot_history(history, save_path='color_training_plots.png')
print('Saved training plots to color_training_plots.png')